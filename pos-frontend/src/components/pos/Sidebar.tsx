...
export default function Sidebar() {
    ...
    // Completely hidden on mobile — bottom nav handles navigation
    return (
        <aside
            className="hidden md:flex sticky top-0 left-0 h-screen w-[72px] bg-card border-r border-card-border flex-col items-center py-5 shrink-0"
        >
            {/* Brand Logo */}
