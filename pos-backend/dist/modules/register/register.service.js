...
exports.registerService = {
    ...
    async closeRegister(userId, closingAmount, notes) {
        ...
        const updated = await prisma.cashRegister.update({
            ...
            data: {
                closed_at: new Date(),
                closing_amount: new client_1.Prisma.Decimal(closingAmount),
                expected_amount: new client_1.Prisma.Decimal(expected),
                notes,
            },
            include: { logs: true },
        });
    ...
    async recordSale(userId, saleAmount) {
        ...
        const log = await prisma.cashRegisterLog.create({
            data: {
                register_id: register.id,
                type: 'SALE',
                amount: new client_1.Prisma.Decimal(saleAmount),
